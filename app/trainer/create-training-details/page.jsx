...
export default function CreateTrainingProgram() {
    ...
    return (
        <div className={styles.traingProgramContainer}>
            ...
            <UploadYoutubeVideoModal isVideoModalOpen={isVideoModalOpen} closeModalVideo={closeModalVideo}
                setTraining={setExerciseWrapper}></UploadYoutubeVideoModal>
            <UploadImageModal isImageModalOpen={isImageModalOpen} closeModalImg={closeModalImg} setTraining={setExercise}>
            </UploadImageModal>
            <main className={styles.main}>
                {exercise.videoUrl ? (
                    <div className={styles.videoWrapper}>
                        <iframe src={exercise.videoUrl} title="YouTube video player"
                            allow="autoplay; accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowFullScreen />
                    </div>
                ) : (
                    <Image src={exercise.imageUrl} alt="Fallback image" width={500} height={500} className={styles.fallbackImage}>
                    </Image>
                )}
                <form className={styles.form}>
                    <p className={styles.imageLoadTitle}>Omslag</p>
                    <div className={styles.buttonContainer}>
                        <button type="button" onClick={openModalImg} className={styles.chooseImageButton}>
                            Välj bild
                        </button>
                        <button type="button" onClick={openModalVideo} className={styles.openBtn}>
                            Välj Video
                        </button>
                    </div>
                    <div className={styles.inputGroup}>
                        ...
                        <input type="number" id="duration" onChange={(e) => setPrice({ duration: e.target.value })}
                        ...
                        <input type="text" id="title" placeholder="min" className={styles.inputProgramTitle}
                            value={exercise.name} />
                    </div>
                    <div className={styles.inputGroup}>
                        ...
                        <textarea type="text" id="description"
                            ...
                            value={exercise.description || ""} className={styles.inputField} />
                    </div>
                    <div className={styles.buttonContainer}>
